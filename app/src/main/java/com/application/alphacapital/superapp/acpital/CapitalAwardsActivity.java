...
public class CapitalAwardsActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.capital_activity_awards);
    ...
    private class AwardRecyclerAdapter extends RecyclerView.Adapter<AwardRecyclerAdapter.ViewHolder>
    {
        ...
        {
            View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.capital_rowview_award, viewGroup, false);
