...
public class CapitalCustomTextViewBold extends AppCompatTextView
{
    public CapitalCustomTextViewBold(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    public CapitalCustomTextViewBold(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        if (!isInEditMode())
        {
    ...
    public CapitalCustomTextViewBold(Context context)
    {
        super(context);
        if (!isInEditMode())
        {
