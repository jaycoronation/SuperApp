...
public class CapitalCustomEditText extends AppCompatEditText implements TextWatcher {
	...
	public CapitalCustomEditText(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		// initViews();
	}

	public CapitalCustomEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		// initViews();
		if (!isInEditMode())
	...
	public CapitalCustomEditText(Context context, AttributeSet attrs, int defStyle) {
