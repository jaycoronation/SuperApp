...
package com.application.alphacapital.superapp.acpital.checkboxlibs;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_CHECKED = Color.parseColor("#771D75");
    private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#666666");
