...
public class CapitalCustomTextViewSemiBold extends AppCompatTextView
{
    public CapitalCustomTextViewSemiBold(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    public CapitalCustomTextViewSemiBold(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        if (!isInEditMode())
        {
    ...
    public CapitalCustomTextViewSemiBold(Context context)
    {
        super(context);
        if (!isInEditMode())
        {
