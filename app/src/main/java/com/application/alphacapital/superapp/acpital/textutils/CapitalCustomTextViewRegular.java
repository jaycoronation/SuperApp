...
public class CapitalCustomTextViewRegular extends AppCompatTextView
{
    public CapitalCustomTextViewRegular(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    public CapitalCustomTextViewRegular(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        if (!isInEditMode())
        {
    ...
    public CapitalCustomTextViewRegular(Context context)
    {
        super(context);
        if (!isInEditMode())
        {
