package com.application.alphacapital.superapp.vault.view;
...
public class VaultCircleImageView extends AppCompatImageView
{

    private static final ScaleType SCALE_TYPE = ScaleType.CENTER_CROP;

    private static final Bitmap.Config BITMAP_CONFIG = Bitmap.Config.ARGB_8888;
    private static final int COLORDRAWABLE_DIMENSION = 20;
    ...
    public VaultCircleImageView(Context context)
    {
        super(context);
    ...
    public VaultCircleImageView(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public VaultCircleImageView(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        mBorderColor = a.getColor(R.styleable.CircleImageView_civ_border_color,
                ContextCompat.getColor(context, R.color.vault_black));
