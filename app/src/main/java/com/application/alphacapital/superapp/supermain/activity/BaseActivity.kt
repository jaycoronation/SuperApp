...
import com.application.alphacapital.superapp.finplan.activity.FinPlanSignupActivity
...
import com.application.alphacapital.superapp.supermain.network.ApiClient
import com.application.alphacapital.superapp.supermain.network.ApiInterface
...
open class BaseActivity : AppCompatActivity() {
    ...
    open fun setStatusBarGradiant(activity: Activity)
    {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
        {
            ...
            val background = ContextCompat.getDrawable(activity, R.drawable.spalsh_gradient)
...
// status bar is hidden, so hide that too if necessary.
    ...
    fun getPrice(price: String) = activity.getString(R.string.rs)+price.takeIf { price.isNotEmpty() }
}
