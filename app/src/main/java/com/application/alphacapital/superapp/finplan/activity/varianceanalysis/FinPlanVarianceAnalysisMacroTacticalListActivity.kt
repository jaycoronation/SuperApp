...
class FinPlanVarianceAnalysisMacroTacticalListActivity : FinPlanBaseActivity()
{
    ...
    {
        tvTitle.text = "Variance Analysis(Macro-Tactical)"
        ivBack.backNav()

        tvNoData.text = "Variance Analysis(Macro-Tactical) not found!"
        rvAspiration.layoutManager = LinearLayoutManager(activity)

        ivGraph.setOnClickListener {
            startActivity<FinPlanGraphActivity>(AppConstant.camefrom.CAME_FROM to AppConstant.camefrom.GRAPH_VARIANCE_MACRO_TACTICAL, "data" to Gson().toJson(listAspiration))
        }
    }
    ...
    private fun getNetWorthList()
    {
        ...
        {
            loader.show()
            apiService.getVarianceAnalysisMacroTactical(sessionManager.userId).enqueue(object : Callback<VarianceAnalysisMacroListResponse>
                {
    ...
    inner class AspirationAdapter(private val list: List<VarianceAnalysisMacroListResponse.VarianceAnalysisMacro.VarianceAnalysis>) : RecyclerView.Adapter<AspirationAdapter.ViewHolder>()
    {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int)
        {
            ...
            holder.itemView.tvVariance.text = getSet.variance/*holder.itemView.tvReturn.text = getSet.`return`
        ...
        inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView)
        {
            ...
            var tvVariance: TextView = itemView.findViewById(R.id.tvVariance)/*var tvReturn:TextView = itemView.findViewById(R.id.tvReturn)
