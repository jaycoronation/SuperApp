...
public class XIRRFundsFragment extends Fragment
{
    ...
    {
        ArrayList<XIRRResponseModel.PerformanceDetailsCateItem> listItems;

        XIRRFundsAdapter(ArrayList<XIRRResponseModel.PerformanceDetailsCateItem> list)
        {
            this.listItems = list;
        }
        ...
        {
            View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.portfolio_row_view_xirr_funds, viewGroup, false);
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position)
        {
            try
            {
                final XIRRResponseModel.PerformanceDetailsCateItem getSet = listItems.get(position);

                holder.txtXirrKey.setText(AppUtils.toDisplayCase(getSet.getPortfolio_key()));
                holder.txtXirrOpeningBalance.setText("Opening Balance on " + getSet.getOpening_balance().getDate() + " : " + getResources().getString(R.string.rupees) + " " + AppUtils.convertToTwoDecimalValue(String.valueOf(getSet.getOpening_balance().getAmount())));
        ...
        public class ViewHolder extends RecyclerView.ViewHolder
        {
            ...
            private TextView txtXirrOpeningBalance;
            ...
            ViewHolder(View convertView)
            {
                ...
                try
                {
                    ...
                    txtXirrOpeningBalance = convertView.findViewById(R.id.txtXirrOpeningBalance);
    ...
    {
        ArrayList<XIRRResponseModel.PortfolioValueItem> listItems;
        private SpringyAdapterAnimator mAnimator;

        XIRRFundsValueAdapter(ArrayList<XIRRResponseModel.PortfolioValueItem> list)
        {
            this.listItems = list;
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position)
        {
            try
            {
                final XIRRResponseModel.PortfolioValueItem getSet = listItems.get(position);
