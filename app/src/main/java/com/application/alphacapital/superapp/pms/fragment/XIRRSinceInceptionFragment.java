...
public class XIRRSinceInceptionFragment extends Fragment
{
    ...
    public XIRRSinceInceptionFragment()
    {
    ...
    private void setData()
    {
        ...
        txtSITotalAmount.setText(getResources().getString(R.string.rupees) + " "  + AppUtils.convertToTwoDecimalValue(XIRRActivity.AmountInvested));
        txtSITotalCurrentValue.setText(getResources().getString(R.string.rupees) + " "  + AppUtils.convertToTwoDecimalValue(XIRRActivity.CurrentValue));
        txtSITotalDays.setText(AppUtils.convertToTwoDecimalValue(XIRRActivity.TotalDays));
        txtSITotalGain.setText(getResources().getString(R.string.rupees) + " "  + AppUtils.convertToTwoDecimalValue(XIRRActivity.Gain));
        txtSITotalReturn.setText(AppUtils.convertToTwoDecimalValue(XIRRActivity.Abreturn) + "%");
        txtSITotalXirr.setText(AppUtils.convertToTwoDecimalValue(XIRRActivity.Xirr) + "%");
    }

    private class SinceInceptionAdapter extends RecyclerView.Adapter<SinceInceptionAdapter.ViewHolder>
    {
        ArrayList<XIRRResponseModel.SinceInceptionDetailsItem> listItems;
        private SpringyAdapterAnimator mAnimator;

        SinceInceptionAdapter(ArrayList<XIRRResponseModel.SinceInceptionDetailsItem> list)
        {
            this.listItems = list;
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position)
        {
            try
            {
                final XIRRResponseModel.SinceInceptionDetailsItem getSet = listItems.get(position);
