...
public class MacroAssetFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState)
    {
        ...
        View rootView = inflater.inflate(R.layout.portfolio_fragment_macro_asset, container, false);
        ...
        {
            listMacroStrategic = getArguments().getParcelableArrayList("data1");
            listMacroTactical = getArguments().getParcelableArrayList("data2");
        }
    ...
    {
        if(listMacroStrategic != null && listMacroStrategic.size() > 0)
        {
            llNoData.setVisibility(View.GONE);

            MicroStrategicAdapter microStrategicAdapter = new MicroStrategicAdapter(listMacroStrategic);
            rvMicroStrategic.setAdapter(microStrategicAdapter);

            MicroTacticalAdapter microTacticalAdapter = new MicroTacticalAdapter(listMacroTactical);
    ...
    {
        ArrayList<NetworthResponseModel.MacroAssetsStrategicItem> listItems;
        private SpringyAdapterAnimator mAnimator;

        MicroStrategicAdapter(ArrayList<NetworthResponseModel.MacroAssetsStrategicItem> list)
        {
            this.listItems = list;
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position)
        {
            try
            {
                final NetworthResponseModel.MacroAssetsStrategicItem getSet = listItems.get(position);
                ...
                else
                {
                    ...
                    holder.txtPolicyPercentage.setText(AppUtils.convertToTwoDecimalValue(String.valueOf(getSet.getPolicy())));
    ...
    {
        ArrayList<NetworthResponseModel.MacroTactical.MacroAssetsTacticalItem> listItems;
        private SpringyAdapterAnimator mAnimator;

        MicroTacticalAdapter(ArrayList<NetworthResponseModel.MacroTactical.MacroAssetsTacticalItem> list)
        {
            this.listItems = list;
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position)
        {
            try
            {
                final NetworthResponseModel.MacroTactical.MacroAssetsTacticalItem getSet = listItems.get(position);
