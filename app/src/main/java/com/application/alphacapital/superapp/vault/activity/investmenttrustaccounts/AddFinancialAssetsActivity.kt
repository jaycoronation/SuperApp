...
class AddFinancialAssetsActivity : VaultBaseActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        if (intent.hasExtra("isForEdit"))
        {
            ...
            {
                govRelatedGetSet = Gson().fromJson(intent.getStringExtra("data"), InvestTrustAccountListResponse.InvestmentTrustAccount::class.java)
            }
        }
    ...
    {
        binding.toolbar.txtTitle.text = "Add Other Financial Assets".takeIf { !isForEdit } ?: "Update Other Financial Assets"
    ...
    private fun setUpViews()
    {
        ...
        if (isForEdit)
        {
            ...
            listViews.add(AddInvestmentTrustAccountGetSet(govRelatedGetSet.asset_name, govRelatedGetSet.institution, govRelatedGetSet.account_number, govRelatedGetSet.amount,
                ...
                govRelatedGetSet.investment_trust_account_id,govRelatedGetSet.nominee_name))
        }
        else
        {
    ...
    private fun addData(items: String)
    {
        try
        {
            if (isOnline())
            {
                ...
                val call = apiService.investTrustAccountSaveCall(itemPart, userIdPart, fromAppPart, parts)
                ...
                call.enqueue(object : Callback<CommonResponse>
                {
                    override fun onResponse(call: Call<CommonResponse>, response: Response<CommonResponse>)
                    {
                        if (response.isSuccessful)
                        {
                            ...
                            {
                                appUtils.sendMessageFromHandler(FinancialAssetsListActivity.handler, "null", 1, 0, 0)
