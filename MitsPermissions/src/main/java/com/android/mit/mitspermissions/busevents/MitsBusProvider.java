 ...
 * interested classes.
 */
public final class MitsBusProvider extends Bus {

	private static MitsBusProvider instance;

	public static MitsBusProvider getInstance() {

		if (instance == null)
			instance = new MitsBusProvider();
	...
	public void post(final Object event) {
		...
		if (Looper.myLooper() == Looper.getMainLooper()) {
			...
			mHandler.post(new Runnable() {
				@Override
				public void run() {
					MitsBusProvider.getInstance().post(event);
				}
			});
		}
